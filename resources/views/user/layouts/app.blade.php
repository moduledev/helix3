...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{route('user.dashboard')}}" class="brand-link">
            <img src="{{asset('img/icon.png')}}" alt="AdminLTE Logo"
                 ...
                 style="opacity: .8">
            <span class="brand-text font-weight-light">HELIX</span>
        </a>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            @include('user.elements.flash-message')
            @yield('content')
        </section>
        <!-- /.content -->
    </div>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2020 <a href="http://adminlte.io">HELIX</a>.</strong>
        All rights reserved.
